...
// Shanks — cheveux rouges, cape rouge, épée Gryphon, manche gauche vide
function Shanks() {
  return (
    <svg viewBox="0 0 100 210" width="90" height="189" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Cape rouge dans le dos */}
      ...
      {/* Cicatrice sur l'œil gauche (trois traits) */}
...
// Trafalgar Law — chapeau tacheté, Kikoku (nodachi immense), hoodie noir col fourrure
function TrafalgaLaw() {
  return (
    <svg viewBox="0 0 100 210" width="90" height="189" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Kikoku — lame sombre immense posée en diagonale */}
      ...
      {/* Garde carrée distinctive de Kikoku */}
      ...
      {/* Chapeau tacheté — large bord caractéristique */}
      {/* Bord */}
      ...
      {/* Tatouage DEATH sur les doigts de la main droite */}
