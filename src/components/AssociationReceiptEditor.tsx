...
import { HeartHandshake, Eye, EyeOff, Printer, ArrowLeft, Bookmark, Library, RotateCcw } from "lucide-react"
import { Button } from "@/components/ui/button"
import { AssociationReceiptForm } from "@/components/AssociationReceiptForm"
import { AssociationReceiptPreview } from "@/components/AssociationReceiptPreview"
import { SaveAssociationReceiptDialog } from "@/components/SaveAssociationReceiptDialog"
...
export function AssociationReceiptEditor({
  receipt,
  onChange,
  onBack,
  ...
  return (
    <div className="min-h-svh bg-muted/40">
        ...
        {showReusePanel ? (
          <div className="space-y-4 animate-in fade-in duration-200">
            <h2 className="text-sm font-medium text-muted-foreground uppercase tracking-wider">
              Réutiliser un reçu association
            </h2>
      ...
      {showResetConfirm && (
        <ConfirmDialog
          title="Réinitialiser le reçu association"
