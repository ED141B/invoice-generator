...
import { computeReceiptTotals } from "@/types/receipt"
...
export function SavedReceiptCard({ saved, onDuplicate, onLoad, onDelete, onRename }: Props) {
  ...
  const { total } = computeReceiptTotals(saved.receipt.amountHT, saved.receipt.taxRate)
